...
<div class="section">
    <div class="container">
        <div class="box">
            <div class="col-2">
            <img src="../produk/produk1655216132.jpg" width="500px">
            </div>
            <div class="col-2">
                <h2> Dieffenbachia </h2>
                    <br>
                    ...
                    <p>
                        <ul>
                            <b>1.Apa yang perlu diperhatikan dalam merawat tanaman dieffenbachia?</b>
                            <li>Memberikan media tanam yang poros yaitu jika disiram air langsung mengalir ke dasar pot, tidak ada genangan di atas pot.</li>
                            <br>
                            ...
                            <br>
                            <li>Jika menyiram tanaman pastikan daun dan ketiak daun tersiram rata ya.</li>
                        </ul>
                    <p>
            </div>
        </div>
